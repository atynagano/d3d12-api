...
impl Deref for D3D12RootSignatureDeserializer {
	type Target = Unknown;
...
impl Com for D3D12RootSignatureDeserializer {
	fn vtable(&self) -> VTable { self.0.vtable() }
}

impl D3D12RootSignatureDeserializer {
	pub fn GetRootSignatureDesc(&self) -> &D3D12RootSignatureDesc {
		unsafe {
...
impl From<UnknownWrapper> for D3D12RootSignatureDeserializer {
