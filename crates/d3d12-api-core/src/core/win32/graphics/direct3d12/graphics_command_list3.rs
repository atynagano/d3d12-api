...
impl ID3D12GraphicsCommandList2 for D3D12GraphicsCommandList3 {
	fn as_graphics_command_list2(&self) -> &D3D12GraphicsCommandList2 { &self.0 }
	fn into_graphics_command_list2(self) -> D3D12GraphicsCommandList2 { self.0 }
}

impl ID3D12GraphicsCommandList1 for D3D12GraphicsCommandList3 {
	fn as_graphics_command_list1(&self) -> &D3D12GraphicsCommandList1 { &self.0.0 }
	fn into_graphics_command_list1(self) -> D3D12GraphicsCommandList1 { self.0.0 }
}

impl ID3D12GraphicsCommandList for D3D12GraphicsCommandList3 {
	fn as_graphics_command_list(&self) -> &D3D12GraphicsCommandList { &self.0.0.0 }
	fn into_graphics_command_list(self) -> D3D12GraphicsCommandList { self.0.0.0 }
}

impl ID3D12CommandList for D3D12GraphicsCommandList3 {
	fn as_command_list(&self) -> &D3D12CommandList { &self.0.0.0.0 }
	fn into_command_list(self) -> D3D12CommandList { self.0.0.0.0 }
}

impl ID3D12DeviceChild for D3D12GraphicsCommandList3 {
	fn as_device_child(&self) -> &D3D12DeviceChild { &self.0.0.0.0.0 }
	fn into_device_child(self) -> D3D12DeviceChild { self.0.0.0.0.0 }
}
