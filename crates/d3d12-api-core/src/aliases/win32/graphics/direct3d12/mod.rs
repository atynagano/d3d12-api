...
pub type RtTier = D3D12RaytracingTier;
...
pub type RtAsSrv = D3D12RaytracingAccelerationStructureSrv;
...
pub type SrvDescAnonymousUnion = D3D12ShaderResourceViewDescAnonymousUnion;
pub type ShaderResourceViewDesc = D3D12ShaderResourceViewDesc;
pub type SrvDesc = D3D12ShaderResourceViewDesc;
pub type ConstantBufferViewDesc = D3D12ConstantBufferViewDesc;
pub type CbvDesc = D3D12ConstantBufferViewDesc;
...
pub type UavDescAnonymousUnion = D3D12UnorderedAccessViewDescAnonymousUnion;
pub type UnorderedAccessViewDesc = D3D12UnorderedAccessViewDesc;
pub type UavDesc = D3D12UnorderedAccessViewDesc;
...
pub type IndirectArgumentDescAnonymousUnionVertexBufferStruct = D3D12IndirectArgumentDescAnonymousUnionVertexBufferStruct;
pub type IndirectArgumentDescAnonymousUnionConstantStruct = D3D12IndirectArgumentDescAnonymousUnionConstantStruct;
pub type IndirectArgumentDescAnonymousUnionConstantBufferViewStruct = D3D12IndirectArgumentDescAnonymousUnionConstantBufferViewStruct;
pub type IndirectArgumentDescAnonymousUnionCbvStruct = D3D12IndirectArgumentDescAnonymousUnionConstantBufferViewStruct;
pub type IndirectArgumentDescAnonymousUnionShaderResourceViewStruct = D3D12IndirectArgumentDescAnonymousUnionShaderResourceViewStruct;
pub type IndirectArgumentDescAnonymousUnionSrvStruct = D3D12IndirectArgumentDescAnonymousUnionShaderResourceViewStruct;
pub type IndirectArgumentDescAnonymousUnionUnorderedAccessViewStruct = D3D12IndirectArgumentDescAnonymousUnionUnorderedAccessViewStruct;
pub type IndirectArgumentDescAnonymousUnionUavStruct = D3D12IndirectArgumentDescAnonymousUnionUnorderedAccessViewStruct;
...
pub type RtAsPostBuildInfoType = D3D12RaytracingAccelerationStructurePostBuildInfoType;
pub type RaytracingAccelerationStructurePostBuildInfoDesc = D3D12RaytracingAccelerationStructurePostBuildInfoDesc;
pub type RtAsPostBuildInfoDesc = D3D12RaytracingAccelerationStructurePostBuildInfoDesc;
...
pub type RtAsPostBuildInfoCompactedSizeDesc = D3D12RaytracingAccelerationStructurePostBuildInfoCompactedSizeDesc;
...
pub type RtAsPostBuildInfoToolsVisualizationDesc = D3D12RaytracingAccelerationStructurePostBuildInfoToolsVisualizationDesc;
...
pub type BuildRtAsToolsVisualizationHeader = D3D12BuildRaytracingAccelerationStructureToolsVisualizationHeader;
...
pub type RtAsPostBuildInfoSerializationDesc = D3D12RaytracingAccelerationStructurePostBuildInfoSerializationDesc;
...
pub type SerializedRtAsHeader = D3D12SerializedRaytracingAccelerationStructureHeader;
...
pub type RtAsPostBuildInfoCurrentSizeDesc = D3D12RaytracingAccelerationStructurePostBuildInfoCurrentSizeDesc;
pub type RaytracingInstanceDesc = D3D12RaytracingInstanceDesc;
pub type RtInstanceDesc = D3D12RaytracingInstanceDesc;
pub type RaytracingGeometryDescAnonymousUnion = D3D12RaytracingGeometryDescAnonymousUnion;
pub type RtGeometryDescAnonymousUnion = D3D12RaytracingGeometryDescAnonymousUnion;
pub type RaytracingGeometryDesc = D3D12RaytracingGeometryDesc;
pub type RtGeometryDesc = D3D12RaytracingGeometryDesc;
pub type BuildRaytracingAccelerationStructureInputsAnonymousUnion<'a> = D3D12BuildRaytracingAccelerationStructureInputsAnonymousUnion<'a>;
pub type BuildRtAsInputsAnonymousUnion<'a> = D3D12BuildRaytracingAccelerationStructureInputsAnonymousUnion<'a>;
pub type BuildRaytracingAccelerationStructureInputs<'a> = D3D12BuildRaytracingAccelerationStructureInputs<'a>;
pub type BuildRtAsInputs<'a> = D3D12BuildRaytracingAccelerationStructureInputs<'a>;
pub type BuildRaytracingAccelerationStructureDesc<'a> = D3D12BuildRaytracingAccelerationStructureDesc<'a>;
pub type BuildRtAsDesc<'a> = D3D12BuildRaytracingAccelerationStructureDesc<'a>;
pub type RaytracingAccelerationStructurePrebuildInfo = D3D12RaytracingAccelerationStructurePrebuildInfo;
pub type RtAsPrebuildInfo = D3D12RaytracingAccelerationStructurePrebuildInfo;
